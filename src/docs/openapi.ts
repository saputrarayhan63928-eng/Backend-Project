...
const bookListOperation = {
  ...
  description:
    "Mengambil daftar buku dengan pagination, pencarian, sorting, filter kategori multiple, stok, dan rentang tahun terbit.",
  ...
  paths: {
    ...
    "/api/admin/stats": {
      get: {
        ...
        description:
          "Menampilkan total buku tersedia, total transaksi aktif (belum dikembalikan), dan buku paling populer.",
        security: [{ BearerAuth: [] }],
        responses: {
          "200": {
