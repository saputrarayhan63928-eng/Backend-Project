...
const buildProductPayload = (req, includeOptional) => {
    const payload = {};
...
export const getAllProducts = asyncHandler(async (req, res) => {
    ...
    const sortBy = req.query.sortBy === "publishedYear" || req.query.sortBy === "title"
        ? req.query.sortBy
        : undefined;
...
export const searchProduct = asyncHandler(async (req, res) => {
    ...
    const page = parseInt(req.query.page) || 1;
    const limit = parseInt(req.query.limit) || 10;
    const result = await ProductService.search(keyword, page, limit);
